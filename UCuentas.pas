...
begin
 if (LENombreCE.Text = '') then
  ...
  begin
   buttonSelected := messagedlg('Esta acción no modificará el valor "Saldo" de la cuenta seleccionada, recuerde que para modificar dicho campo de una cuenta debe ir a la pantalla "Cobrar Cuentas"',mtConfirmation, mbOKCancel, 0);
    if buttonSelected = mrOK     then
      begin
        with DataModule1.FDTCuenta do
          begin
